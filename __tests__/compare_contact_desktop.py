...
figma_path = root / "__tests__/figma_contact_desktop_1440x490.png"
full_path = root / "__tests__/contact_desktop_fullpage.png"
local_path = root / "__tests__/contact_desktop_local_crop.png"
overlay_path = root / "__tests__/contact_desktop_overlay.png"
diff_path = root / "__tests__/contact_desktop_diff.png"
metrics_path = root / "__tests__/contact_desktop_diff_metrics.txt"

figma = Image.open(figma_path).convert("RGBA")
full = Image.open(full_path).convert("RGBA")
local = full.crop((0, 3197, 1440, 3687))
